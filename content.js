...
document.getElementsByTagName("link")[0].sizes="512x512";*/
    ...
    if (isChatTyping == false) {
      ...
      if (key == "x" || key == "X") {
        ...
        if (document.getElementById("noa-canvas") != null) {
          document.getElementById("noa-canvas").style.transform = "scale(5)";
          console.log("game should be zoomeed");
        }
  ...
  */
  ...
  function gamekeyup(eventis) {
    ...
    if (key == "x" || "X") {
      if (document.getElementById("noa-canvas") != null) {
        document.getElementById("noa-canvas").style.transform = "scale(1)";
        console.log("changed zoom back to normal");
      }
